#!/usr/bin/env python3
"""Fail closed unless the isolated Rust target and source package use one core."""
...
def fail(message: str) -> None:
    print(f"rust-one-core: {message}", file=sys.stderr)
    raise SystemExit(1)
...
def main() -> int:
    ...
    if release.get("wholeRepositoryPackage") != "opto-sync/opto-sync-clients@0.3.0":
    ...
    print(f"Rust/whole-repository one-core preflight passed: syncer.c={gitlink}")
    return 0
