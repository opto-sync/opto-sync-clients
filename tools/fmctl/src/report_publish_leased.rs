...
fn open_confined_lock_file(path: &Path, create: bool, truncate: bool) -> Result<File, FmError> {
...
fn lock_is_contended(error: &io::Error) -> bool {
    error.kind() == io::ErrorKind::WouldBlock || matches!(error.raw_os_error(), Some(libc::EAGAIN))
}
